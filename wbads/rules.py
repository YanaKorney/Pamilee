...
# У кампаний типа 9 тип ставки виден только в карточке кампании, а для
# решений он важнее самого типа: ручную ставку менеджер меняет сам,
# единую за него считает WB.
BID_TYPE_NAMES = {
