...
Всё лежит в папке пользователя, в «Документах». Никаких облаков:
...
когда вы сами нажимаете «Разобрать план» или «Создать визуализацию».
    ...
    Документы/Моя квартира/data/projects/<id>/uploads/   планы и референсы
    Документы/Моя квартира/data/projects/<id>/previews/  превью страниц PDF
    Документы/Моя квартира/data/projects/<id>/renders/   кадры и визуализации
"""
